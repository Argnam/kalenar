...
function renderEvents() {
	...
	events.forEach((event) => {
		...
		event.text == '' ? el.append(`<textarea onchange="changeEventText(${event.id}, this.value)" placeholder="Введите заметку"></textarea>`) : el.append(`<textarea onchange="changeEventText(${event.id}, this.value)" placeholder="Введите заметку">${event.text}</textarea>`)
